<?php
class SettingItemDescriptionFunctionsController extends BasicController
{
  const _INDEX = 'description_functions';
  const _LIST  = 'list';
  const _GET   = 'get';
  const _POST  = 'post';
  ...
  private function verify($data)
  {
    ...
    if (!strlen($data['description_functions_ja'])) {

      $errors[] = '機能の日本語を入力してください';
    }

    if (!strlen($data['description_functions_en'])) {

      $errors[] = '機能の英語を入力してください';
    }
