<?php $this->setPageTitle('title', 'フリマウォッチ') ?>
...
<form action="<?php print $base_url; ?>/research/free/markets/watch/post"
      method="post"
  ...
  <table id="dt"
    ...
    <thead>
      ...
      <tr>
        ...
        <th rowspan="1" class="text-center info">
          <span class="text-primary">マーケット</span>
        </th>
    ...
    <tbody>
      ...
      <?php foreach ($research_free_markets_watchs as $index => $research_free_markets_watch): ?>

      <?php   print $this->render(
                $view_path . '/individual',
                array(
                  'index' => $index,
                  'research_free_markets_watch' => $research_free_markets_watch,
                  'view_path' => $view_path,
                )
              );
      ?>
