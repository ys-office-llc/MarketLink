<?php $this->setPageTitle('title', 'ヤフオク検索一覧') ?>
  ...
  <div class="table-responsive">
    <table id="dt"
      ...
      <tbody>
        ...
        <?php foreach ($research_yahoo_auctions_searchs as $research_yahoo_auctions_search): ?>
        <?php   print $this->render(
                  $view_path . '/individual',
                  array(
                    'research_yahoo_auctions_search' => $research_yahoo_auctions_search,
                    'view_path' => $view_path,
                  )
                );
        ?>
